...
%The system
k11 = 3.17; k12 = 0.73; k21 = 0.56; k22 = 3.16;
K = [k11, k12 ; k21 , k22];
...
for i=2:N
   % node 1
   [d1, cost1,cagalhao1] = primal_solve(node1, rho, cagalhao1);
   node1.d = d1;
   ...
   %node2
   [d2, cost2,cagalhao2] = primal_solve(node2, rho, cagalhao2);
   node2.d = d2;
...
function [d, cost,cagalhao] = primal_solve(node, rho, cagalhao)
    d_best = [-1,-1]';
    ...
    % compute minimum constrained to linear and 0 boundary (ILB and DLB)
    d_l0 = (1/rho)*z - ...
